...
## NOTE FROM ELLA: this doesn't use any of our data, it just uses her's to create a tree that's already in the
...
source("GitHub_tutorial/DietR/lib/Food_tree_scripts/check.db.r")
source("GitHub_tutorial/DietR/lib/Food_tree_scripts/format.foods_2.r")
source("GitHub_tutorial/DietR/lib/Food_tree_scripts/filter.db.by.diet.records.r")
...
# BiocManager::install("ggtree") # ella ran once to update packages
...
SpecifyDataDirectory(directory.name = "GitHub_tutorial/DietR/eg_data/Food_tree_eg/")
...
## this had been done from when i downloaded data from github
